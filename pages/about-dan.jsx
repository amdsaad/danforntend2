      ...
      <section className="mt-40 mb-20 ">
        <div className="container">
          <div className="flex flex-col items-center gap-5 lg:gap-10">
            <Image
              className="mx-auto hidden scrubElements scrubUp  lg:block"
              width={84}
              height={84}
              src={`/home/l2.png`}
              alt=""
            />
            <Image
              className="mx-auto block  scrubElements scrubUp lg:hidden"
              width={40}
              height={40}
              src={`/home/l2.png`}
              alt=""
            />
            <p className="text-[#552A0E] text-center text-[14px] lg:text-[18px] thin lg:w-4/5 scrubElements scrubUp">
          ...
          <div className="container h-full">
            <div className="w-full h-full hidden items-center lg:grid grid-cols-2 gap-20">
              <div
                ...
                } scrubElements scrubLeft child_h h-full hover:bg-[#ffffff10] py-24`}
              >
                <Image
              ...
              <div
                ...
                } scrubElements scrubRight child_h h-full hover:bg-[#ffffff10] py-24`}
              >
                <Image
                  className="mx-auto hidden lg:block"
                  width={84}
