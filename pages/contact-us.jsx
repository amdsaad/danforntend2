    ...
    <div className=" relative w-full min-h-screen">
      <section>
        <div className="w-full relative  min-h-screen">
          ...
          <Image src="/contact/heromob.png" alt="hero" className="block lg:hidden" fill objectFit="cover" />
          <div className="absolute w-full h-full z-10">
            <div className="container h-full ">
              <div className=" flex flex-col h-full justify-center  lg:lg:justify-end items-start lg:pb-32">
                <h1 className=" text-[24px]  lg:text-[35px] text-white font-bold">{title}</h1>
