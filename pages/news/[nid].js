            ...
            <div className="container h-full ">
              ...
              <div className="flex items-center mt-10 justify-between">
                <div className="flex items-center gap-4">
                  <div
                    className="px-5 rounded-full py-1 text-[9px] lg:text-base text-white"
                    style={{
                  ...
                  <p className="text-[9px] lg:text-xl text-txt">
                    {t('postDate')}
                  </p>
                  <p className="text-[9px] lg:text-xl text-txt">
...
const BigScreenVideo = () => {
  ...
  return (
    ...
    >
      ...
      >
        <source src={post?.viedo} type="video/mp4" />
      ...
      <iframe
        width="100%"
        height="600"
        src={`https://www.youtube.com/embed/${post?.viedo}`}
        frameborder="0"
        allowfullscreen
      ></iframe>
