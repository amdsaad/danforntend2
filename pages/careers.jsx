    ...
    <div className="min-h-screen relative w-full">
      ...
      <section>
        <div className="w-full relative  min-h-screen">
          <Image src="/comp/hero.png" alt="hero" className="hidden lg:block introFadeUp" fill objectFit="cover" />
          <Image src="/comp/heromob.png" alt="hero" className="block lg:hidden introFadeUp" fill objectFit="cover" />
          <div className="absolute w-full h-full z-10">
            <div className="container h-full ">
              <div className=" flex flex-col h-full justify-center  lg:lg:justify-end items-start lg:pb-32">
                <h1 className=" text-[24px]  lg:text-[50px] text-white font-bold introFadeUp">{cultureTitle}</h1>
                <p className="text-white text-[16px] lg:text-[16px] lg:w-3/5 py-6 introFadeUp">{culture}</p>
      ...
      <section className="mt-40 mb-20">
        <div className="container">
          <div className="flex flex-col items-center gap-5 lg:gap-10">
            ...
            <Image className="mx-auto block lg:hidden scrubElements scrubRotateFadeUp" width={40} height={40} src={introImage} alt="" />
            <p className="text-[#552A0E] text-center text-[14px] lg:text-[18px] thin lg:w-4/5 scrubElements scrubFadeUp">{intro}</p>
          </div>
        </div>
      </section>
