    ...
    <div className=" flex items-center gap-4">
      {contacts.instagram ? (
        <a target="_blank" href={contacts.instagram}>
          <AiOutlineInstagram className=" w-5 h-5 text-white thin transition hover:text-pr" />
        </a>
      ) : null}

      {contacts.linkedin ? (
        <a target="_blank" href={contacts.linkedin}>
          <AiFillLinkedin className=" w-5 h-5 text-white thin transition hover:text-pr" />
        </a>
      ) : null}
      {contacts.threads ? (
        <a target="_blank" href={contacts.threads}>
          ...
          >
            ...
            >
              <path
                className="transition hover:fill-pr"
                id="Subtraction_1"
      ...
      {contacts.snapchat ? (
        <a target="_blank" href={contacts.snapchat}>
          <AiOutlineYoutube className=" w-5 h-5 text-white thin transition hover:text-pr" />
        </a>
      ) : null}
    </div>
  );
